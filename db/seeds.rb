...
aliou = User.create!(
  first_name: "Aliou",
  last_name: "Pas",
  email: "aliou@yugo.com",
  password: "password123"
)
aliou.avatar.attach(io: File.open(Rails.root.join('app/assets/images/Aliou_avatar.jpg')), filename: 'Aliou_avatar.jpg', content_type: 'image/jpeg')
